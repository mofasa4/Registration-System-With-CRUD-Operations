    ...
    <div class="row">
        <div class="col-md-4 admin">
            ...
            <div class="form-group hiden">
                <input type="text" id="item" class="form-control" name="item" placeholder="Item title "
                    autocomplete="off"><br>
                <input type="text" id="itemdes" class="form-control" name="description" placeholder="Item description"
                    autocomplete="off"><br>
                <input type="file" id="itemimg" class="form-control" class="form-control" name="image" accept="image/*"
                    directory><br>
